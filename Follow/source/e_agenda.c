...
//	IPC0bits.T2IP = 2;                                      // timer priority should be above user code
 ...
 * \return EXIT_OK if the agenda has been created, exit otherwise
 */
 ...
 * \return EXIT_OK if the agenda has been destroyed, AG_NOT_FOUND otherwise
 */
 ...
 * \return EXIT_OK if the cycle of the agenda has been modified,
 *         AG_NOT_FOUND otherwise
 */
 ...
 * \return EXIT_OK if the cycle of the agenda has been reseted,
 *         AG_NOT_FOUND otherwise
 ...
 * \return EXIT_OK the agenda has been paused,
 *         AG_NOT_FOUND otherwise
 */
 ...
 * \return EXIT_OK if he agenda has been restarted,
 *         AG_NOT_FOUND otherwise
 * \sa e_pause_agenda
 */
